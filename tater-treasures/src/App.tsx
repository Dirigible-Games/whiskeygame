...
export default function App() {
  ...
  const [gameState, setGameState] = useState<GameState>(() => {
    ...
    return {
      ...
      skills: {
        ...
        [WhiskeyType.BLENDED_SCOTCH]: { level: 0, xp: 0 },
  ...
  return (
    <>
      ...
      {/* Header */}
      <header className="bg-whiskey-medium text-white pb-2 pt-[max(0.5rem,env(safe-area-inset-top))] px-3 sm:px-6 h-auto min-h-[48px] shadow-2xl sticky top-0 z-50 border-b border-whiskey-light">
